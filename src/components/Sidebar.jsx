...
import stepData from "../constants/stepData.js";

const Sidebar = () => {
  return (
    <aside className="absolute top-0 left-0 right-[100%] sm:relative bg-mobile sm:bg sm:bg-desktop sm:bg-cover bg-no-repeat w-[100%] h-[100%] pt-8 sm:pl-8 sm:basis-[30%] sm:rounded-lg flex items-start justify-center sm:flex-col sm:justify-start">
