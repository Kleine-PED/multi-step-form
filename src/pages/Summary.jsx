...
const Summary = () => {
  ...
  const { selectedMonthlyPlan } = useContext(SelectPlanContext);
  const { selectedYearlyPlan } = useContext(SelectPlanContext);
  ...
  return (
    <div className="sm:basis-[60%] w-[300px] sm:w-[100%] h-[100%] sm:pr-[80px] text-center">
      <h1 className="mt-10 text-3xl font-[800] mb-2 text-primary-marineBlue text-left">
        Finishing up
      </h1>
      <p className="text-neutral-coolGray mb-6 hidden sm:block text-left">
        ...
        <div className="plan flex justify-between items-center mb-4">
          <div>
            ...
            <p
              ...
              className="text-neutral-coolGray underline cursor-pointer text-left"
            >
              Change
            </p>
          </div>
